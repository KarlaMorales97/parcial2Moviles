package com.morales.parcial2moviles.Games.Lol;
...
public class ActivityLol extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //NEW ACTIVITY
                Intent i = new Intent(ActivityLol.this, MainActivity.class);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    GeneralLol generalFragment= new GeneralLol();
                    return generalFragment;

                case 1:
                    PlayersLol playersFragment = new PlayersLol();
