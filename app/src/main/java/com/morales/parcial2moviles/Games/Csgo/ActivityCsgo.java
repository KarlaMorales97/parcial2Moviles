...
public class ActivityCsgo extends AppCompatActivity {
    /**
     ...
     */
    private ActivityCsgo.SectionsPagerAdapter mSectionsPagerAdapter;
...
//        getSupportActionBar().setDisplayShowTitleEnabled(true);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //NEW ACTIVITY
                Intent i = new Intent(ActivityCsgo.this, MainActivity.class);
    ...
    public static class PlaceholderFragment extends Fragment {
         ...
         * number.
         */
        public static ActivityCsgo.PlaceholderFragment newInstance(String game) {
            ActivityCsgo.PlaceholderFragment fragment = new PlaceholderFragment();
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    GeneralCsgo generalFragment= new GeneralCsgo();
